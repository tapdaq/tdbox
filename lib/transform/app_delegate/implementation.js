...
var applicationId, clientKey, orientation, testMode, frequencyCap;

var TransformStream = function(appId, cKey, orient, testM, freqCap) {
...
var addTapdaqInit = function(chunkStr) {
  ...
  if (tmpSplitString.length === 2) {
    tmpSplitString[0] += config.app_delegate_m.searchLaunchOptions + '\n' +
      config.app_delegate_m.init(applicationId, clientKey, orientation, testMode, frequencyCap);
  }
